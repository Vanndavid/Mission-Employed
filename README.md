...
*   **Simulation Environment:** Practice timed verbal responses to dynamically generated behavioral challenges.
*   **Live Transcription:** Integrated real-time audio recording and transcription powered by Gemini's native audio-to-text capabilities.
...
*   **Framework:** React 19 (Modern ES modules)
*   **Styling:** Tailwind CSS (Optimized for Dark/Light modes)
*   **Intelligence:** Google Gemini API (`@google/genai`) - utilized for content generation, speech analysis, and job description scoring.
*   **Native Integration:** Web Audio API for PCM streaming and MediaDevices API for real-time microphone capture.
*   **Persistence:** LocalStorage-based state persistence with native JSON Export/Import functionality for data portability.

## 🎯 The Philosophy

The modern software engineering job market is noisy and demoralizing. **Mission: Employed** operates on the principle that *Applying is mechanical, not strategic.* 

By quantifying the process into daily "Protocols," the user maintains high output and avoids the cognitive load of "emotional analysis." This is not a project for browsing—it is a tool for executing until the mission is complete.

---
*Built for the Simulation Protocol. Execution is everything.*