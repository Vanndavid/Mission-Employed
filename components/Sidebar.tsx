...
export const Sidebar = ({ theme, toggleTheme }: SidebarProps) => {
  ...
  const tabs = [
    ...
    { path: '/applications/contacts', label: 'Contacts', sub: 'CRM & Follow-ups', icon: '📇' },
    { path: '/applications/profile', label: 'CV & Profile', sub: 'Frozen Documents', icon: '📄' },
    { path: '/applications/offers', label: 'Offer Tools', sub: 'Compare & Negotiate', icon: '💰' },
